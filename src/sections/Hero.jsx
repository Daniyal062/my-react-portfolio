    ...
    <section id="hero" className={styles.hero}>
      ...
      <div className={styles.bottom}>
        <p className={styles.desc}>
          I'm <strong>Daniyal Maqood</strong> — a designer who codes and a developer who
          obsesses over every pixel. I work across the full product stack: from early
          research and Figma prototypes to shipped React code.
        </p>
        <div className={styles.meta}>
          <div className={styles.stats}>
            <div className={styles.stat}>
              <div className={styles.statN}>1.5+</div>
